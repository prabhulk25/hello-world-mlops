...
def parse_args():
    ...
    p.add_argument("--csv", default="data/test.csv", help="Path to CSV (default: data/test.csv)")
    p.add_argument("--target", default="quality", help="Target column name (default: quality)")
    p.add_argument("--experiment", default="test-prediction", help="MLflow experiment name")
